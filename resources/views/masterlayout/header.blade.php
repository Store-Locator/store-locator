...
<!-- Search Box -->
<div class="col-lg-5 col-md-8 col-sm-20 col-12" style="margin-left: 20%;margin-top:1%;margin-bottom:1%;">
...
<!-- <div class="container">
    <div class="row">    
        <div class="col-lg-5 col-md-7 col-xs-8 col-xs-offset-2" style="margin-left: 20%;margin-top:1%;margin-bottom:1%;">
